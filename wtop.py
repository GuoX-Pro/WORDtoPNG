...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(':g.ico'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "WORD to PNG"))
        self.groupBox.setTitle(_translate("MainWindow", "WORD选取"))
...
class MyWindowsMain(QMainWindow, Ui_MainWindow):
    ...
    def PDFPathButtonClick(self):
        # 选择PDF文件
        openfile_name = QFileDialog.getOpenFileName(self, "选择Word文件", '*.doc;*.docx')
        if openfile_name[0] != '':
    ...
    def OKButtonClick(self):
        ...
        conver1=conver(self.PDFPathEdit.text(),self.PNGPathEdit.text(),1)
        conver1.conver()
